    ...
    <div className="rounded-[10px] bg-white py-4 px-6 h-[320px]">
      <div className="flex">
        ...
        <div className="ml-2">
          ...
          <p className="text-base font-normal m-0">{company}</p>
        </div>
      </div>
      <div className="ml-14">
        ...
        <p className="mt-6 text-base text-[#212427]">{jobType}</p>
        <p className="m-0 text-base text-[#212427]">{experience}</p>
        <p className="text-base">{ctc}</p>
