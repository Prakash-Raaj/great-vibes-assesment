  ...
  return (
    <div className="rounded-[10px] bg-white py-4 px-6 h-[320px]">
      ...
      <div className="ml-14">
        ...
        <p className="text-base">{employees} employees</p>
        <div className="flex mt-6">
          {radioValue === 0 ? (
            <>
              <button className="bg-[#1597E4] text-base font-medium rounded-md px-4 py-2 mr-6 text-white">
                Apply Now
              </button>
              <button className="text-[#1597E4] border-[#1597E4] text-base font-medium rounded-md  px-4 py-2 border-2 mr-[461px]">
                External Apply
              </button>
            </>
          ) : radioValue === '2' ? (
